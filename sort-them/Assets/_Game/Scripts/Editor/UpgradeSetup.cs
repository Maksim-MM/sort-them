...
namespace SortThem.Editor
{
    public static class UpgradeSetup
    {
        ...
        static readonly Def[] Defs =
        {
            ...
            new Def { Id = "slot_crate", Kind = UpgradeKind.PartsCrate, Source = UpgradeSource.Slot, Dev = "Parts crate", DevDesc = "Slot machine: +1 parts crate for special cars, 10 in the pool", Ru = "Ящик запчастей", RuDesc = "+1 ящик для прокачки особых машин", En = "Parts crate", EnDesc = "+1 crate to upgrade special cars", Costs = new int[10], Values = SeqF(1f, 1f, 10) },
