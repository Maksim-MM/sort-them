...
{
    [CustomEditor(typeof(MouseIconsSet))]
    public class MouseIconsSetEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < iconsProperty.arraySize; i++)
            {
                ...
                MouseGlyph glyph = (MouseGlyph)glyphProp.enumValueIndex;
        ...
        {
            var existingGlyphs = new HashSet<MouseGlyph>();
            ...
            for (int i = iconsProperty.arraySize - 1; i >= 0; i--)
            {
                ...
                var glyph = (MouseGlyph)glyphProp.enumValueIndex;
            ...
            foreach (var glyph in Enum.GetValues(typeof(MouseGlyph)).Cast<MouseGlyph>())
            {
                if (existingGlyphs.Add(glyph))
                {
